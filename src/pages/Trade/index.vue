  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      >
        ...
        <p @click="changeDefaul(address, addressInfo)">
...
export default {
  ...
  computed: {
    ...
    //将来提交订单，最终选中地址
    userDefaultAddress() {
      //find：札沼数组中符合条件的元素返回，作为最终结果
      return this.addressInfo.find((item) => item.isDefault == 1) || {};
    },
  },
  methods: {
    //修改默认地址
    changeDefaul(address, addressInfo) {
      //先让全部的default为0
    ...
    async submitOrder() {
      ...
      let data = {
        ...
        consigneeTel: this.userDefaultAddress.phoneNum, //最终收件人手机号码
